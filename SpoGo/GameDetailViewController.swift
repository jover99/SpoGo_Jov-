...
class GameDetailViewController: UIViewController, MKMapViewDelegate {
    ...
    var sportsArray = ["- Select Sport -","Football","Hockey","Basketball","Soccer","Golf","PingPong","Cricket","Bicycle","Baseball","Archery","Crew","Run","Tennis","Volleyball","Weights"]
    var game: Game!
    ...
    func updateUI() {
        ...
        self.numberOfPeopleTextField.text = String(self.game.numPeopleNeeded)
...
extension GameDetailViewController: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        if sportsArray[row] == "- Select Sport -" {
            saveBarButton.isEnabled = false
        } else {
